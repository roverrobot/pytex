...
mod = Module("toks",
    ...
    parameters={
        ...
        "everyhbox": {"value": [], "accessor": accessor.ParameterAccessor, "domain": "parameters", "type": ToksValuePointer},
        "everyvbox": {"value": [], "accessor": accessor.ParameterAccessor, "domain": "parameters", "type": ToksValuePointer},
        "everyjob": {"value": [], "accessor": accessor.ParameterAccessor, "domain": "parameters", "type": ToksValuePointer},
        "everycr": {"value": [], "accessor": accessor.ParameterAccessor, "domain": "parameters", "type": ToksValuePointer},
        "errhelp": {"value": [], "accessor": accessor.ParameterAccessor, "domain": "parameters", "type": ToksValuePointer},
        "everypar": {"value": [], "accessor": accessor.ParameterAccessor, "domain": "parameters", "type": ToksValuePointer},
        "everymath": {"value": [], "accessor": accessor.ParameterAccessor, "domain": "parameters", "type": ToksValuePointer},
        "everydisplay": {"value": [], "accessor": accessor.ParameterAccessor, "domain": "parameters", "type": ToksValuePointer},
    }
)
